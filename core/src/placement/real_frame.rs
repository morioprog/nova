...
fn get_real_place_frames_11(h: &[usize; 8]) -> i32 {
    match () {
        _ if h[2] == 12 && h[4] >= 12 => 12, // NOTE: inaccurate
        _ if h[1] <= 11 && h[2] <= 11 => 0,  // NOTE: may be 2 if max(h1, h2) >= 11?
...
fn get_real_place_frames_21(h: &[usize; 8]) -> i32 {
    match () {
        ...
        _ if h[2] <= 11 && h[4] <= 11 => 4, // NOTE: inaccurate
...
fn get_real_place_frames_23(h: &[usize; 8]) -> i32 {
    match () {
        ...
        _ if h[1] <= 11 && h[2] <= 11 && h[1] > h[2] => 2,
        _ if h[1] <= 11 && h[2] <= 11 && h[1] < h[2] => 4,
        _ if h[2] == 12 && h[3] == 11 => 9,
...
fn get_real_place_frames_43(h: &[usize; 8]) -> i32 {
    match () {
        ...
        _ if h[2] > 11 && h[4] <= 11 => 0,  // NOTE: inaccurate
        _ if h[3] == 11 && h[4] == 12 => 0, // NOTE: not ready yet
...
fn get_real_place_frames_52(h: &[usize; 8]) -> i32 {
    match () {
        ...
        _ if h[3] == 11 && h[4] == 12 && h[5] >= 9 && h[6] <= 12 => 8,
        _ if h[3] == 11 && h[4] == 12 && h[6] <= 12 => 9,
        _ if h[3] == 11 && h[4] == 12 && h[6] > 12 => 8,
...
fn get_real_place_frames_53(h: &[usize; 8]) -> i32 {
    match () {
        ...
        _ if h[2] > 12 && h[4] == 12 => 13,
        _ if h[2] >= 12 && h[4] <= 11 && h[5] <= 11 => 2, // NOTE: inaccurate
        _ if h[2] < 12 && h[4] <= 11 && h[5] <= 11 => 1,
        _ if h[3] == 11 && h[4] == 12 && h[5] == 12 => 6,
        _ if h[3] == 11 && h[4] == 12 => 7,
